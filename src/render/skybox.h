...
namespace renderer
{
    ...
    public:
        ...
        virtual void UnserializeJSON(std::string s)
        {
            ...
            auto shader = resources::LoadMeta<common::ShaderProgram>(shaderpth);
            auto box = resources::LoadMeta<common::Texture2D>(boxpth);
            this->irradiance_map = resources::LoadMeta<common::Texture2D>(irrpth);
            this->prefiltered_map = resources::LoadMeta<common::Texture2D>(prefpth);
            this->lut_map = resources::LoadMeta<common::Texture2D>("./src/render/lut.json");
